...
const CLI_PATHS_CONFIG_FILE = path.join(os.homedir(), ".claude-command-center", "cli-paths.json");
...
const APP_SETTINGS_FILE = path.join(os.homedir(), ".claude-command-center", "app-settings.json");
const KANBAN_FILE = path.join(os.homedir(), ".claude-command-center", "kanban-tasks.json");
